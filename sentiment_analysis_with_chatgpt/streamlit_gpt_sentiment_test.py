...
with tab2:
    ...
    options_lissage = ['2W', '3W', '1M', "2M", '3M']
...
with col2:
    with st.expander("Voir les commentaires sélectionnés"):
...
with col2:
    with st.form("Paramètres du modèle"):
        ...
        st.form_submit_button(label="Appliquer les paramètres")
...
launch_request = st.button(label= "Lancer la requête")

if launch_request and openai_api_key:
